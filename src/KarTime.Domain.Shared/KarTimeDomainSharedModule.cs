...
public class KarTimeDomainSharedModule : AbpModule
{
    public override void PreConfigureServices(ServiceConfigurationContext context)
    {
        KarTimeGlobalFeatureConfigurator.Configure();
        KarTimeModuleExtensionConfigurator.Configure();
    }
    ...
    public override void ConfigureServices(ServiceConfigurationContext context)
    {
        ...
        {
            options.FileSets.AddEmbedded<KarTimeDomainSharedModule>();
        });

        Configure<AbpLocalizationOptions>(options =>
        {
            options.Resources
                .Add<KarTimeResource>("en")
                .AddBaseTypes(typeof(AbpValidationResource))
                .AddVirtualJson("/Localization/KarTime");

            options.DefaultResourceType = typeof(KarTimeResource);
        ...
        {
            options.MapCodeNamespace("KarTime", typeof(KarTimeResource));
        });
    }
}
