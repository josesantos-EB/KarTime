...
public class MongoDbKarTimeDbSchemaMigrator : IKarTimeDbSchemaMigrator, ITransientDependency
{
    private readonly IServiceProvider _serviceProvider;

    public MongoDbKarTimeDbSchemaMigrator(IServiceProvider serviceProvider)
    {
